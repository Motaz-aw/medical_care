...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage system bookings</span>
        </h3>
        <div class="card-toolbar">
            @can('Create-booking')
            <a href="{{route('bookings.create')}}" class="btn btn-info font-weight-bolder font-size-sm">New booking</a>
            @endcan
        </div>
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center " id="kt_advance_table_widget_2">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$booking->id}}</a>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$booking->doctor->name}}</a>
                        </td>
                        ...
                        <td>
                            <span class="badge @if($booking->booking) bg-success @else bg-danger @endif">{{$booking->booking_visibility}}</span>
                        </td>
                        ...
                        <td class="pr-0 text-center">
                            ...
                            {{-- @endcan --}}
                            {{-- @can('Delete-Admin') --}}
                            <a href="#" onclick="performDestroy('{{$booking->id}}',this)"
...
<script>
    ...
    function performDestroy(id, ref){
     ...
     function destroy(id, ref) {
         //JS - Axios
        axios.delete('/cms/admin/bookings/'+id)
